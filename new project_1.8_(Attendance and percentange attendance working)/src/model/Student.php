...
//        print '<br>' . $totalPresent;
//        print '<br>' . $totalAbscent;
        $totalClasses = $totalAbscent + $totalPresent;
//        print '<br>' . $totalClasses;
    ...
    /**
     * @param mixed $totalAttended
     */
    public function setTotalAttended($totalAttended)
    {
    ...
    /**
     * @param mixed $totalMissed
     */
    public function setTotalMissed($totalMissed)
    {
